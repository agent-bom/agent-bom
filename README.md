...
`agent-bom` maps the full trust chain from every source of AI workloads — local configs, Docker images, Kubernetes pods, Terraform, GitHub Actions — through MCP servers and packages to known CVEs, answering the question traditional SBOMs can't:
